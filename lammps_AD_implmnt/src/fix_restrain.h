...
class FixRestrain : public Fix {
 ...
 private:
  ...
  int *mult;
  int **ids;
  myScalar *kstart,*kstop,*target;
  myScalar *cos_target,*sin_target;
  myScalar energy,energy_all;
  myScalar ebond,ebond_all;
  myScalar eangle,eangle_all;
  myScalar edihed,edihed_all;
