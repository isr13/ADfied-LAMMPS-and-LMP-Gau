...
void Natural_Cubic_Spline( LAMMPS_NS::Error* error_ptr, const myScalar *h, const myScalar *f,
                           cubic_spline_coef *coef, unsigned int n )
{
  ...
  a = (myScalar*) smalloc(error_ptr,  n * sizeof(myScalar), "cubic_spline:a");
  b = (myScalar*) smalloc(error_ptr,  n * sizeof(myScalar), "cubic_spline:a");
  c = (myScalar*) smalloc(error_ptr,  n * sizeof(myScalar), "cubic_spline:a");
  d = (myScalar*) smalloc(error_ptr,  n * sizeof(myScalar), "cubic_spline:a");
  v = (myScalar*) smalloc(error_ptr,  n * sizeof(myScalar), "cubic_spline:a");
...
void Complete_Cubic_Spline( LAMMPS_NS::Error* error_ptr, const myScalar *h, const myScalar *f, myScalar v0, myScalar vlast,
                            cubic_spline_coef *coef, unsigned int n )
{
  int i;
  myScalar *a, *b, *c, *d, *v;
                        ...
                        storage *workspace, mpi_datatypes *mpi_data, char * /*msg*/ )
{
  ...
  myScalar dr;
  myScalar *h, *fh, *fvdw, *fele, *fCEvd, *fCEclmb;
  myScalar v0_vdw, v0_ele, vlast_vdw, vlast_ele;
  ...
  h = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:h");
  fh = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:fh");
  fvdw = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:fvdw");
  fCEvd = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:fCEvd");
  fele = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:fele");
  fCEclmb = (myScalar*)
    smalloc(system->error_ptr,  (control->tabulate+2) * sizeof(myScalar), "lookup:fCEclmb");
  ...
  MY_MPI_Allreduce( existing_types, aggregated, MAX_ATOM_TYPES,
