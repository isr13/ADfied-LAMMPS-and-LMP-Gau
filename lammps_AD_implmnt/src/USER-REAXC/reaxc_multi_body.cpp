                  ...
                  output_controls * /*out_control*/ )
{
  ...
  myScalar Delta_lpcorr, dfvl;
  myScalar e_lp, expvd2, inv_expvd2, dElp, CElp, DlpVi;
  myScalar e_lph, Di, vov3, deahu2dbo, deahu2dsbo;
  myScalar e_ov, CEover1, CEover2, CEover3, CEover4;
  myScalar exp_ovun1, exp_ovun2, sum_ovun1, sum_ovun2;
  myScalar exp_ovun2n, exp_ovun6, exp_ovun8;
  myScalar inv_exp_ovun1, inv_exp_ovun2, inv_exp_ovun2n, inv_exp_ovun8;
  myScalar e_un, CEunder1, CEunder2, CEunder3, CEunder4;
  myScalar p_lp2, p_lp3;
  myScalar p_ovun2, p_ovun3, p_ovun4, p_ovun5, p_ovun6, p_ovun7, p_ovun8;
  myScalar eng_tmp;
  int numbonds;
