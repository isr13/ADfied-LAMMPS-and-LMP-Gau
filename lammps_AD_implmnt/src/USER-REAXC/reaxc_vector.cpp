...
void rvec_Scale( rvec ret, myScalar c, rvec v )
{
...
void rvec_ScaledAdd( rvec ret, myScalar c, rvec v )
{
  ret[0] += c * v[0], ret[1] += c * v[1], ret[2] += c * v[2];
}


void rvec_ScaledSum( rvec ret, myScalar c1, rvec v1 ,myScalar c2, rvec v2 )
{
...
myScalar rvec_Dot( rvec v1, rvec v2 )
{
...
myScalar rvec_Norm_Sqr( rvec v )
{
  return SQR(v[0]) + SQR(v[1]) + SQR(v[2]);
}


myScalar rvec_Norm( rvec v )
{
...
void ivec_Scale( ivec dest, myScalar C, ivec src )
{
  dest[0] = (int)(C * src[0]);
  dest[1] = (int)(C * src[1]);
  dest[2] = (int)(C * src[2]);
