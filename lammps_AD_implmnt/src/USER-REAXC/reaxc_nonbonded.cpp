                         ...
                         reax_list **lists, output_controls * /*out_control*/ )
{
  ...
  myScalar p_vdW1, p_vdW1i;
  myScalar powr_vdW1, powgi_vdW1;
  myScalar tmp, r_ij, fn13, exp1, exp2;
  myScalar Tap, dTap, dfn13, CEvd, CEclmb, de_core;
  myScalar dr3gamij_1, dr3gamij_3;
  myScalar e_ele, e_vdW, e_core, SMALL = 0.0001;
  myScalar e_lg, de_lg, r_ij5, r_ij6, re6;
  rvec temp, ext_press;
                                   ...
                                   output_controls * /*out_control*/ )
{
  ...
  int start_i, end_i, flag;
  rc_tagint orig_i, orig_j;
  myScalar r_ij, base, dif;
  myScalar e_vdW, e_ele;
  myScalar CEvd, CEclmb, SMALL = 0.0001;
  myScalar f_tmp, delij[3];
...
void LR_vdW_Coulomb( reax_system *system, storage *workspace,
        control_params *control, int i, int j, myScalar r_ij, LR_data *lr )
{
  myScalar p_vdW1 = system->reax_param.gp.l[28];
  myScalar p_vdW1i = 1.0 / p_vdW1;
  myScalar powr_vdW1, powgi_vdW1;
  myScalar tmp, fn13, exp1, exp2;
  myScalar Tap, dTap, dfn13;
  myScalar dr3gamij_1, dr3gamij_3;
  myScalar e_core, de_core;
  myScalar e_lg, de_lg, r_ij5, r_ij6, re6;
  two_body_parameters *twbp;
