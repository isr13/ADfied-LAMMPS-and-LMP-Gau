    ...
    for( i = 0; i < N; ++i ) {
      ...
      if (Hindex > -1) {
        system->my_atoms[i].num_hbonds =
          (int)(MAX( Num_Entries(Hindex, hbonds)*ad::passive_value(saferzone), MIN_HBONDS ));
                        ...
                        int *bond_top, int *num_3body )
{
  ...
  *Htop = (int)(MAX( *Htop * ad::passive_value(safezone), mincap * MIN_HENTRIES ));
  for( i = 0; i < system->n; ++i )
    hb_top[i] = (int)(MAX( hb_top[i] * ad::passive_value(saferzone), MIN_HBONDS ));
