            ...
            output_controls * /*out_control*/ )
{
  ...
  int start_i, end_i;
  int type_i, type_j;
  myScalar ebond, pow_BOs_be2, exp_be12, CEbo;
  myScalar gp3, gp4, gp7, gp10, gp37;
  myScalar exphu, exphua1, exphub1, exphuov, hulpov, estriph;
  myScalar decobdbo, decobdboua, decobdboub;
