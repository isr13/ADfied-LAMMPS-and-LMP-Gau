...
void rvec_Scale( rvec, myScalar, rvec );
void rvec_Add( rvec, rvec );
void rvec_ScaledAdd( rvec, myScalar, rvec );
void rvec_ScaledSum( rvec, myScalar, rvec, myScalar, rvec );
myScalar rvec_Dot( rvec, rvec );
void rvec_iMultiply( rvec, ivec, rvec );
void rvec_Cross( rvec, rvec, rvec );
myScalar rvec_Norm_Sqr( rvec );
myScalar rvec_Norm( rvec );
...
void ivec_Scale( ivec, myScalar, ivec );
