...
{
  myScalar d1, d7;
  myScalar swa, swa2, swa3;
  myScalar swb, swb2, swb3;
                 ...
                 mpi_datatypes * /*mpi_data*/, char * /*msg*/ )
{
  ...
  bond_cap = (int)(MAX( total_bonds*ad::passive_value(safezone), mincap*MIN_BONDS ));
  ...
  /* 3bodies list */
  cap_3body = (int)(MAX( num_3body*ad::passive_value(safezone), MIN_3BODIES ));
