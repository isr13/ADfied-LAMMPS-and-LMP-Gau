...
class CommBrick : public Comm {
 public:
  ...
  void forward_comm_array(int, myScalar **);         // forward comm of array
  int exchange_variable(int, myScalar *, myScalar *&);  // exchange on neigh stencil
 ...
 protected:
  ...
  myScalar *slablo,*slabhi;           // bounds of slab to send at each swap
  myScalar **multilo,**multihi;       // bounds of slabs for multi-type swap
  myScalar **cutghostmulti;           // cutghost on a per-type basis
  ...
  int updown(int, int, int, myScalar, int, myScalar *);
