...
void FixSpring::spring_tether()
{
  ...
  myScalar dx,dy,dz,fx,fy,fz,r,dr;
...
void FixSpring::spring_couple()
{
  ...
  myScalar dx,dy,dz,fx,fy,fz,fx2,fy2,fz2,r,dr;
...
myScalar FixSpring::compute_scalar()
{
  return espring;
}
...
myScalar FixSpring::compute_vector(int n)
{
  return ftotal[n];
}
