...
void PairCoulDSF::compute(int eflag, int vflag)
{
  ...
  myScalar qtmp,xtmp,ytmp,ztmp,delx,dely,delz,ecoul,fpair;
  myScalar r,rsq,r2inv,forcecoul,factor_coul;
...
myScalar PairCoulDSF::init_one(int /*i*/, int /*j*/)
{
  return cut_coul;
}
...
myScalar PairCoulDSF::single(int i, int j, int /*itype*/, int /*jtype*/, myScalar rsq,
                           myScalar factor_coul, myScalar /*factor_lj*/,
                           myScalar &fforce)
{
  myScalar r2inv,r,erfcc,erfcd,prefactor,t;
  myScalar forcecoul,phicoul;
