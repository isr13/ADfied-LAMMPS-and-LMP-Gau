...
myScalar ComputePropertyChunk::memory_usage()
{
  myScalar bytes = (bigint) nchunk * nvalues * sizeof(myScalar);
...
void ComputePropertyChunk::pack_count(int n)
{
  ...
  MY_MPI_Allreduce(count_one,count_all,nchunk,MPI_INT,MPI_SUM,world);
