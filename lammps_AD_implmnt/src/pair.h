...
class Pair : protected Pointers {
 ...
 public:
  ...
  myScalar eng_vdwl,eng_coul;      // accumulated energies
  myScalar virial[6];              // accumulated virial
  myScalar *eatom,**vatom;         // accumulated per-atom energy/virial

  myScalar cutforce;               // max cutoff for all atom pairs
  myScalar **cutsq;                // cutoff sq for each atom pair
  ...
  myScalar **cutghost;             // cutoff for each ghost pair
  ...
  myScalar etail,ptail;            // energy/pressure tail corrections
  myScalar etail_ij,ptail_ij;
  ...
  myScalar tabinnersq;
  myScalar tabinnerdispsq;
  myScalar *rtable,*drtable,*ftable,*dftable,*ctable,*dctable;
  myScalar *etable,*detable,*ptable,*dptable,*vtable,*dvtable;
  myScalar *rdisptable, *drdisptable, *fdisptable, *dfdisptable;
  myScalar *edisptable, *dedisptable;
  int ncoulshiftbits,ncoulmask;
  int ndispshiftbits, ndispmask;

  int nextra;                    // # of extra quantities pair style calculates
  myScalar *pvector;               // vector of extra pair quantities

  int single_extra;              // number of extra single values calculated
  myScalar *svector;               // vector of extra single quantities
  ...
  virtual void reinit();
  virtual void setup() {}
  myScalar mix_energy(myScalar, myScalar, myScalar, myScalar);
  myScalar mix_distance(myScalar, myScalar);
  void write_file(int, char **);
  void init_bitmap(myScalar, myScalar, int, int &, int &, int &, int &);
  virtual void modify_params(int, char **);
  void compute_dummy(int, int);

  // need to be public, so can be called by pair_style reaxc

  void v_tally(int, myScalar *, myScalar *);
  void ev_tally(int, int, int, int, myScalar, myScalar, myScalar,
                myScalar, myScalar, myScalar);
  void ev_tally3(int, int, int, myScalar, myScalar,
                 myScalar *, myScalar *, myScalar *, myScalar *);
  void v_tally3(int, int, int, myScalar *, myScalar *, myScalar *, myScalar *);
  void v_tally4(int, int, int, int, myScalar *, myScalar *, myScalar *,
                myScalar *, myScalar *, myScalar *);
  void ev_tally_xyz(int, int, int, int, myScalar, myScalar,
                    myScalar, myScalar, myScalar, myScalar, myScalar, myScalar);
  ...
  virtual myScalar single(int, int, int, int,
                        myScalar, myScalar, myScalar,
                        myScalar& fforce) {
    fforce = 0.0;
    return 0.0;
  ...
  virtual myScalar init_one(int, int) {return 0.0;}

  virtual void init_tables(myScalar, myScalar *);
  virtual void init_tables_disp(myScalar);
  ...
  virtual int pack_forward_comm(int, int *, myScalar *, int, int *) {return 0;}
  virtual void unpack_forward_comm(int, int, myScalar *) {}
  virtual int pack_reverse_comm(int, int, myScalar *) {return 0;}
  ...
  virtual void swap_eam(myScalar *, myScalar **) {}
  virtual void reset_dt() {}
  virtual void min_xf_pointers(int, myScalar **, myScalar **) {}
  virtual void min_xf_get(int) {}
  virtual void min_x_set(int) {}
  virtual void transfer_history(myScalar *, myScalar*) {}
 ...
 protected:
  ...
  myScalar tabinner;                     // inner cutoff for Coulomb table
  myScalar tabinner_disp;                 // inner cutoff for dispersion table
 ...
 protected:
  ...
  void ev_unset();
  void ev_tally_full(int, myScalar, myScalar, myScalar, myScalar, myScalar, myScalar);
  void ev_tally_xyz_full(int, myScalar, myScalar,
                         myScalar, myScalar, myScalar, myScalar, myScalar, myScalar);
  void ev_tally4(int, int, int, int, myScalar,
                 myScalar *, myScalar *, myScalar *, myScalar *, myScalar *, myScalar *);
  void ev_tally_tip4p(int, int *, myScalar *, myScalar, myScalar);
  void v_tally2(int, int, myScalar, myScalar *);
