...
class FixAveChunk : public Fix {
 public:
  ...
  void setup(int);
  void end_of_step();
  myScalar compute_array(int,int);
 ...
 private:
  ...
  myScalar *count_one,*count_many,*count_sum;
  myScalar **values_one,**values_many,**values_sum;
  myScalar *count_total,**count_list;
  myScalar **values_total,***values_list;
