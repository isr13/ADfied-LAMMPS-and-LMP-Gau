...
void FixMomentum::end_of_step()
{
  ...
  if (rescale) {
    ...
    MY_MPI_Allreduce(&ke,&ekin_old,1,MPI_DOUBLE,MPI_SUM,world);
  }
  ...
  if (rescale) {
    ...
    MY_MPI_Allreduce(&ke,&ekin_new,1,MPI_DOUBLE,MPI_SUM,world);
