...
void ComputeHeatFlux::compute_vector()
{
  ...
  myScalar *ke = c_ke->vector_atom;
  myScalar *pe = c_pe->vector_atom;
  myScalar **stress = c_stress->array_atom;

  myScalar **v = atom->v;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;

  myScalar jc[3] = {0.0,0.0,0.0};
  myScalar jv[3] = {0.0,0.0,0.0};
  myScalar eng;
  ...
  myScalar data[6] = {jc[0]+jv[0],jc[1]+jv[1],jc[2]+jv[2],jc[0],jc[1],jc[2]};
  MY_MPI_Allreduce(data,vector,6,MPI_DOUBLE,MPI_SUM,world);
}
