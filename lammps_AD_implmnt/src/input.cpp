...
/* ----------------------------------------------------------------------
   ...
   narg = # of args
   arg[] = individual args
   treat text between single/myScalar/triple quotes as one arg via nextword()
------------------------------------------------------------------------- */
...
void Input::parse()
{
  ...
  // do not strip from a # inside single/myScalar/triple quotes
  // quoteflag = 1,2,3 when encounter first single/myScalar,triple quote
  // quoteflag = 0 when encounter matching single/myScalar,triple quote
  ...
  // nextword() treats text between single/myScalar/triple quotes as one arg
...
/* ----------------------------------------------------------------------
   ...
   treat text between single/myScalar/triple quotes as one arg
...
char *Input::nextword(char *str, char **next)
{
  ...
  // if start is single/myScalar/triple quote:
  ...
  // if start is not single/myScalar/triple quote:
...
void Input::substitute(char *&str, char *&str2, int &max, int &max2, int flag)
{
  ...
  // do not replace $ inside single/myScalar/triple quotes
...
void Input::ifthenelse()
{
  ...
  myScalar btest = variable->evaluate_boolean(line);
...
void Input::special_bonds()
{
  ...
  myScalar lj2 = force->special_lj[2];
  myScalar lj3 = force->special_lj[3];
  myScalar coul2 = force->special_coul[2];
  myScalar coul3 = force->special_coul[3];
