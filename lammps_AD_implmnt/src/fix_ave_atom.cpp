...
myScalar FixAveAtom::memory_usage()
{
  myScalar bytes;
  bytes = atom->nmax*nvalues * sizeof(myScalar);
  return bytes;
}
...
int FixAveAtom::pack_exchange(int i, myScalar *buf)
{
...
int FixAveAtom::unpack_exchange(int nlocal, myScalar *buf)
{
