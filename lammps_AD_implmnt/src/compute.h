...
class Compute : protected Pointers {
 public:
  ...
  myScalar scalar;            // computed global scalar
  myScalar *vector;           // computed global vector
  myScalar **array;           // computed global array
  ...
  myScalar dof;         // degrees-of-freedom for temperature
  ...
  virtual void remove_bias(int, myScalar *) {}
  virtual void remove_bias_thr(int, myScalar *, myScalar *) {}
  virtual void remove_bias_all() {}
  virtual void reapply_bias_all() {}
  virtual void restore_bias(int, myScalar *) {}
  virtual void restore_bias_thr(int, myScalar *, myScalar *) {}
 ...
 protected:
  ...
  myScalar natoms_temp;          // # of atoms used for temperature calculation
  myScalar extra_dof;            // extra DOF for temperature computes
  int fix_dof;                 // DOF due to fixes
  int dynamic;                 // recount atoms for temperature computes
  int dynamic_user;            // user request for temp compute to be dynamic

  myScalar vbias[3];             // stored velocity bias for one atom
  myScalar **vbiasall;           // stored velocity bias for all atoms
