...
class Output : protected Pointers {
 public:
  ...
  int restart_flag_myScalar;     // 1 if myScalar restart files are written
  ...
  bigint next_restart_myScalar;  // next timestep to write a myScalar restart file
  int restart_every_single;    // single restart file write freq, 0 if var
  int restart_every_myScalar;    // myScalar restart file write freq, 0 if var
  ...
  char *var_restart_myScalar;    // variable name for myScalar restart freq
  int ivar_restart_single;     // index of var_restart_single
  int ivar_restart_myScalar;     // index of var_restart_myScalar
  char *restart1;              // name single restart file
  char *restart2a,*restart2b;  // names of myScalar restart files
