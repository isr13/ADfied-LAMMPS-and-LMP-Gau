...
int RegBlock::inside(myScalar x, myScalar y, myScalar z)
{
...
int RegBlock::surface_interior(myScalar *x, myScalar cutoff)
{
  myScalar delta;
...
int RegBlock::surface_exterior(myScalar *x, myScalar cutoff)
{
  myScalar xp,yp,zp;
  myScalar xc,yc,zc,dist,mindist;
...
myScalar RegBlock::find_closest_point(int i, myScalar *x,
                                    myScalar &xc, myScalar &yc, myScalar &zc)
{
  myScalar dot,d2,d2min;
  myScalar xr[3],xproj[3],p[3];
...
int RegBlock::inside_face(myScalar *xproj, int iface)
{
  if (iface < 2) {
