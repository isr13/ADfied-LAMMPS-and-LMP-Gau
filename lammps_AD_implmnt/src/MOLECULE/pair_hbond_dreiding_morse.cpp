...
void PairHbondDreidingMorse::compute(int eflag, int vflag)
{
  ...
  myScalar factor_hb,force_angle,force_kernel,force_switch,evdwl,ehbond;
  myScalar c,s,a,b,d,ac,a11,a12,a22,vx1,vx2,vy1,vy2,vz1,vz2;
  myScalar fi[3],fj[3],delr1[3],delr2[3];
  myScalar r,dr,dexp,eng_morse,switch1,switch2;
...
void PairHbondDreidingMorse::coeff(int narg, char **arg)
{
  ...
  myScalar d0_one = force->numeric(FLERR,arg[4]);
  myScalar alpha_one = force->numeric(FLERR,arg[5]);
  myScalar r0_one = force->numeric(FLERR,arg[6]);
...
void PairHbondDreidingMorse::init_style()
{
  ...
  for (int m = 0; m < nparams; m++) {
    ...
    /*
    if (offset_flag) {
      myScalar alpha_dr = -params[m].alpha * (params[m].cut - params[m].r0);
...
myScalar PairHbondDreidingMorse::single(int i, int j, int itype, int jtype,
                                     myScalar rsq,
                                     ...
                                     myScalar &fforce)
{
  ...
  tagint tagprev;
  myScalar eng,eng_morse,force_kernel,force_angle;
  myScalar rsq1,rsq2,r1,r2,c,s,ac,r,dr,dexp,factor_hb;
