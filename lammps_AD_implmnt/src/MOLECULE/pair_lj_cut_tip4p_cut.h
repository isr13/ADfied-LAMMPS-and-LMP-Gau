...
class PairLJCutTIP4PCut : public Pair {
 ...
 protected:
  myScalar cut_lj_global,cut_coul_global;
  myScalar cut_coul,cut_coulsq;
  myScalar cut_coulsqplus;       // extended value for cut_coulsq
  myScalar **cut_lj,**cut_ljsq;
  myScalar **epsilon,**sigma;
  myScalar **lj1,**lj2,**lj3,**lj4,**offset;

  int typeH,typeO;             // atom types of TIP4P water H and O atoms
  int typeA,typeB;             // angle and bond types of TIP4P water
  myScalar alpha;                // geometric constraint parameter for TIP4P
  myScalar qdist;
  ...
  myScalar **newsite;            // locations of charge sites

  void allocate();
  void compute_newsite(myScalar *, myScalar *, myScalar *, myScalar *);
};
}
