...
void AngleCosinePeriodic::compute(int eflag, int vflag)
{
  ...
  myScalar tn,tn_1,tn_2,un,un_1,un_2;
...
void AngleCosinePeriodic::coeff(int narg, char **arg)
{
  ...
  myScalar c_one = force->numeric(FLERR,arg[1]);
...
myScalar AngleCosinePeriodic::equilibrium_angle(int /*i*/)
{
  return MY_PI;
}
...
myScalar AngleCosinePeriodic::single(int type, int i1, int i2, int i3)
{
  myScalar **x = atom->x;
