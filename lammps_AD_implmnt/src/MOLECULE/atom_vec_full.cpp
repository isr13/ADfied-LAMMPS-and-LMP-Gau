...
int AtomVecFull::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecFull::pack_comm_vel(int n, int *list, myScalar *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecFull::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecFull::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecFull::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecFull::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecFull::pack_border(int n, int *list, myScalar *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecFull::pack_border_vel(int n, int *list, myScalar *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecFull::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecFull::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecFull::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecFull::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecFull::pack_exchange(int i, myScalar *buf)
{
  int k;
...
int AtomVecFull::unpack_exchange(myScalar *buf)
{
  int k;
...
int AtomVecFull::pack_restart(int i, myScalar *buf)
{
  int k;
...
int AtomVecFull::unpack_restart(myScalar *buf)
{
  int k;
...
void AtomVecFull::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecFull::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecFull::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecFull::pack_data_hybrid(int i, myScalar *buf)
{
...
void AtomVecFull::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecFull::write_data_hybrid(FILE *fp, myScalar *buf)
{
