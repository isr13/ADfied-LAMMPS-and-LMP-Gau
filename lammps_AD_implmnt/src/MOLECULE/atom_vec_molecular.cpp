...
int AtomVecMolecular::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecMolecular::pack_comm_vel(int n, int *list, myScalar *buf,
                                    int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecMolecular::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecMolecular::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecMolecular::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecMolecular::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecMolecular::pack_border(int n, int *list, myScalar *buf,
                                  int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecMolecular::pack_border_vel(int n, int *list, myScalar *buf,
                                      int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecMolecular::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecMolecular::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecMolecular::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecMolecular::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecMolecular::pack_exchange(int i, myScalar *buf)
{
  int k;
...
int AtomVecMolecular::unpack_exchange(myScalar *buf)
{
  int k;
...
int AtomVecMolecular::pack_restart(int i, myScalar *buf)
{
  int k;
...
int AtomVecMolecular::unpack_restart(myScalar *buf)
{
  int k;
...
void AtomVecMolecular::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecMolecular::data_atom(myScalar *coord, imageint imagetmp,
                                 char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecMolecular::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecMolecular::pack_data_hybrid(int i, myScalar *buf)
{
...
void AtomVecMolecular::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecMolecular::write_data_hybrid(FILE *fp, myScalar *buf)
{
