...
class BondTable : public Bond {
 public:
  ...
  void coeff(int, char **);
  myScalar equilibrium_distance(int);
  void write_restart(FILE *);
  void read_restart(FILE *);
  void write_restart_settings(FILE *);
  void read_restart_settings(FILE *);
  myScalar single(int, myScalar, int, int, myScalar &);
 ...
 protected:
  ...
  struct Table {
    int ninput,fpflag;
    myScalar fplo,fphi,r0;
    myScalar lo,hi;
    myScalar *rfile,*efile,*ffile;
    myScalar *e2file,*f2file;
    myScalar delta,invdelta,deltasq6;
    myScalar *r,*e,*de,*f,*df,*e2,*f2;
  };
  ...
  void spline(myScalar *, myScalar *, int, myScalar, myScalar, myScalar *);
  myScalar splint(myScalar *, myScalar *, myScalar *, int, myScalar);

  void uf_lookup(int, myScalar, myScalar &, myScalar &);
  void u_lookup(int, myScalar, myScalar &);
};
