...
void DihedralOPLS::compute(int eflag, int vflag)
{
  ...
  myScalar s2,cx,cy,cz,cmag,dx,phi,si,siinv,sin2;
...
void DihedralOPLS::coeff(int narg, char **arg)
{
  ...
  myScalar k1_one = force->numeric(FLERR,arg[1]);
  myScalar k2_one = force->numeric(FLERR,arg[2]);
  myScalar k3_one = force->numeric(FLERR,arg[3]);
  myScalar k4_one = force->numeric(FLERR,arg[4]);
...
{
  fwrite(&k1[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  fwrite(&k2[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  fwrite(&k3[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  fwrite(&k4[1],sizeof(myScalar),atom->ndihedraltypes,fp);
}
...
void DihedralOPLS::read_restart(FILE *fp)
{
  ...
  if (comm->me == 0) {
    fread(&k1[1],sizeof(myScalar),atom->ndihedraltypes,fp);
    fread(&k2[1],sizeof(myScalar),atom->ndihedraltypes,fp);
    fread(&k3[1],sizeof(myScalar),atom->ndihedraltypes,fp);
    fread(&k4[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  }
