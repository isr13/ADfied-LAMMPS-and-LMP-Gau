...
int AtomVecAngle::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecAngle::pack_comm_vel(int n, int *list, myScalar *buf,
                                int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecAngle::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecAngle::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecAngle::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecAngle::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecAngle::pack_border(int n, int *list, myScalar *buf,
                              int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecAngle::pack_border_vel(int n, int *list, myScalar *buf,
                                  int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecAngle::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecAngle::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecAngle::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecAngle::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecAngle::pack_exchange(int i, myScalar *buf)
{
  int k;
...
int AtomVecAngle::unpack_exchange(myScalar *buf)
{
  int k;
...
int AtomVecAngle::pack_restart(int i, myScalar *buf)
{
  int k;
...
int AtomVecAngle::unpack_restart(myScalar *buf)
{
  int k;
...
void AtomVecAngle::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecAngle::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecAngle::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecAngle::pack_data_hybrid(int i, myScalar *buf)
{
...
void AtomVecAngle::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecAngle::write_data_hybrid(FILE *fp, myScalar *buf)
{
