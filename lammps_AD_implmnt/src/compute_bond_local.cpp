...
int ComputeBondLocal::compute_bonds(int flag)
{
  ...
  tagint tagprev;
  myScalar dx,dy,dz,rsq;
  myScalar mass1,mass2,masstotal,invmasstotal;
  myScalar xcm[3],vcm[3];
  myScalar delr1[3],delr2[3],delv1[3],delv2[3];
  myScalar r12[3],vpar1,vpar2;
  myScalar vvib,vrotsq;
  myScalar inertia,omegasq;
  myScalar mvv2e;
  myScalar engpot,engtrans,engvib,engrot,fbond;
  myScalar *ptr;
...
int ComputeBondLocal::pack_forward_comm(int n, int *list, myScalar *buf,
...
void ComputeBondLocal::unpack_forward_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
myScalar ComputeBondLocal::memory_usage()
{
