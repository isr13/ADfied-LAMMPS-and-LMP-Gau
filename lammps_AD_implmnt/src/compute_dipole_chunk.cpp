...
void ComputeDipoleChunk::compute_array()
{
  ...
  MY_MPI_Allreduce(chrgproc,chrgtotal,nchunk,MPI_DOUBLE,MPI_SUM,world);
  ...
  MY_MPI_Allreduce(&dipole[0][0],&dipoleall[0][0],4*nchunk,
