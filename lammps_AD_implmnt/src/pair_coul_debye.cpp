...
void PairCoulDebye::compute(int eflag, int vflag)
{
  ...
  myScalar rsq,r2inv,r,rinv,forcecoul,factor_coul,screening;
...
myScalar PairCoulDebye::single(int i, int j, int /*itype*/, int /*jtype*/,
                           myScalar rsq, myScalar factor_coul, myScalar /*factor_lj*/,
                           myScalar &fforce)
{
  myScalar r2inv,r,rinv,forcecoul,phicoul,screening;
