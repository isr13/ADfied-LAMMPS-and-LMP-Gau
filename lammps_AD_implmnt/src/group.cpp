...
void Group::assign(int narg, char **arg)
{
  ...
  myScalar rlocal = n;
  myScalar all;
  MY_MPI_Allreduce(&rlocal,&all,1,MPI_DOUBLE,MPI_SUM,world);
...
bigint Group::count_all()
{
  ...
  bigint nall;
  MY_MPI_Allreduce(&nme,&nall,1,MPI_LMP_BIGINT,MPI_SUM,world);
  return nall;
}
...
bigint Group::count(int igroup)
{
  ...
  bigint nsingle = n;
  bigint nall;
  MY_MPI_Allreduce(&nsingle,&nall,1,MPI_LMP_BIGINT,MPI_SUM,world);
  return nall;
}
...
myScalar Group::mass(int igroup)
{
  int groupbit = bitmask[igroup];

  myScalar *mass = atom->mass;
  myScalar *rmass = atom->rmass;
  int *mask = atom->mask;
  int *type = atom->type;
  int nlocal = atom->nlocal;
  ...
  myScalar all;
  MY_MPI_Allreduce(&one,&all,1,MPI_DOUBLE,MPI_SUM,world);
  return all;
}
...
myScalar Group::mass(int igroup, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
myScalar Group::charge(int igroup)
{
  int groupbit = bitmask[igroup];
  ...
  myScalar qall;
  MY_MPI_Allreduce(&qone,&qall,1,MPI_DOUBLE,MPI_SUM,world);
  return qall;
}
...
myScalar Group::charge(int igroup, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::bounds(int igroup, myScalar *minmax)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(extent,minmax,6,MPI_DOUBLE,MPI_MAX,world);
...
void Group::bounds(int igroup, myScalar *minmax, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::xcm(int igroup, myScalar masstotal, myScalar *cm)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(cmone,cm,3,MPI_DOUBLE,MPI_SUM,world);
  if (masstotal > 0.0) {
    cm[0] /= masstotal;
    cm[1] /= masstotal;
    cm[2] /= masstotal;
...
void Group::xcm(int igroup, myScalar masstotal, myScalar *cm, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::vcm(int igroup, myScalar masstotal, myScalar *cm)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(p,cm,3,MPI_DOUBLE,MPI_SUM,world);
  if (masstotal > 0.0) {
    cm[0] /= masstotal;
    cm[1] /= masstotal;
    cm[2] /= masstotal;
...
void Group::vcm(int igroup, myScalar masstotal, myScalar *cm, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::fcm(int igroup, myScalar *cm)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(flocal,cm,3,MPI_DOUBLE,MPI_SUM,world);
}
...
void Group::fcm(int igroup, myScalar *cm, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
myScalar Group::ke(int igroup, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
myScalar Group::gyration(int igroup, myScalar masstotal, myScalar *cm)
{
  int groupbit = bitmask[igroup];
  ...
  myScalar rg_all;
  MY_MPI_Allreduce(&rg,&rg_all,1,MPI_DOUBLE,MPI_SUM,world);
...
myScalar Group::gyration(int igroup, myScalar masstotal, myScalar *cm, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::angmom(int igroup, myScalar *cm, myScalar *lmom)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(p,lmom,3,MPI_DOUBLE,MPI_SUM,world);
}
...
void Group::angmom(int igroup, myScalar *cm, myScalar *lmom, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::torque(int igroup, myScalar *cm, myScalar *tq)
{
  int groupbit = bitmask[igroup];
  ...
  MY_MPI_Allreduce(tlocal,tq,3,MPI_DOUBLE,MPI_SUM,world);
}
...
void Group::torque(int igroup, myScalar *cm, myScalar *tq, int iregion)
{
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
  region->prematch();
...
void Group::inertia(int igroup, myScalar *cm, myScalar itensor[3][3])
{
  int i,j;
  ...
  MY_MPI_Allreduce(&ione[0][0],&itensor[0][0],9,MPI_DOUBLE,MPI_SUM,world);
}
...
void Group::inertia(int igroup, myScalar *cm, myScalar itensor[3][3], int iregion)
{
  int i,j;
...
void Group::omega(myScalar *angmom, myScalar inertia[3][3], myScalar *w)
{
  myScalar idiag[3],ex[3],ey[3],ez[3],cross[3];
  myScalar evectors[3][3],inverse[3][3];

  // determinant = triple product of rows of inertia matrix

  myScalar determinant = inertia[0][0]*inertia[1][1]*inertia[2][2] +
