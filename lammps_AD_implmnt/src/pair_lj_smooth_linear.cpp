...
myScalar PairLJSmoothLinear::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
  ...
  myScalar cut6inv = pow(cut[i][j],-6.0);
  myScalar cutinv  = 1.0/cut[i][j];
...
myScalar PairLJSmoothLinear::single(int /*i*/, int /*j*/, int itype, int jtype,
                                  myScalar rsq,
                                  myScalar /*factor_coul*/, myScalar factor_lj,
                                  myScalar &fforce)
{
  myScalar r2inv,r6inv,forcelj,philj,r,rinv;
