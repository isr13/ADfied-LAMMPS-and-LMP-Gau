...
class DumpCustom : public Dump {
 ...
 protected:
  ...
  myScalar *thresh_value;      // threshold value for each nthresh
  ...
  myScalar *dchoose;           // value for each atom to threshold against
  ...
  myScalar **vbuf;             // local storage for variable evaluation
  ...
  int count();
  void pack(tagint *);
  virtual int convert_string(int, myScalar *);
  virtual void write_data(int, myScalar *);
  bigint memory_usage();
  ...
  typedef int (DumpCustom::*FnPtrConvert)(int, myScalar *);
  FnPtrConvert convert_choice;          // ptr to convert data functions
  int convert_image(int, myScalar *);
  int convert_noimage(int, myScalar *);

  typedef void (DumpCustom::*FnPtrWrite)(int, myScalar *);
  FnPtrWrite write_choice;             // ptr to write data functions
  void write_binary(int, myScalar *);
  void write_string(int, myScalar *);
  void write_lines(int, myScalar *);
