...
int ComputeContactAtom::pack_reverse_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void ComputeContactAtom::unpack_reverse_comm(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
myScalar ComputeContactAtom::memory_usage()
{
