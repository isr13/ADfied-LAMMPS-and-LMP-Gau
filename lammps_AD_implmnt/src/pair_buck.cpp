...
void PairBuck::compute(int eflag, int vflag)
{
  ...
  myScalar rsq,r2inv,r6inv,forcebuck,factor_lj;
  myScalar r,rexp;
...
myScalar PairBuck::init_one(int i, int j)
{
  ...
  if (offset_flag && (cut[i][j] > 0.0)) {
    myScalar rexp = exp(-cut[i][j]/rho[i][j]);
...
myScalar PairBuck::single(int /*i*/, int /*j*/, int itype, int jtype,
                        myScalar rsq, myScalar /*factor_coul*/, myScalar factor_lj,
                        myScalar &fforce)
{
  myScalar r2inv,r6inv,r,rexp,forcebuck,phibuck;
