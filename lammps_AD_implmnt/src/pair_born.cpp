...
void PairBorn::compute(int eflag, int vflag)
{
  ...
  myScalar rsq,r2inv,r6inv,forceborn,factor_lj;
  myScalar r,rexp;
...
myScalar PairBorn::init_one(int i, int j)
{
  ...
  if (offset_flag && (cut[i][j] > 0.0)) {
    myScalar rexp = exp((sigma[i][j]-cut[i][j])*rhoinv[i][j]);
...
myScalar PairBorn::single(int /*i*/, int /*j*/, int itype, int jtype,
                        myScalar rsq, myScalar /*factor_coul*/, myScalar factor_lj,
                        myScalar &fforce)
{
  myScalar r2inv,r6inv,r,rexp,forceborn,phiborn;
