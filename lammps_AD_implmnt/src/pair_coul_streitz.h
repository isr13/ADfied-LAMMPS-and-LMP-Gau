...
class PairCoulStreitz : public Pair {
 ...
 protected:
  struct Param {
    myScalar chi, eta, gamma, zeta, zcore;
    int ielement;
  };
  ...
  // Kspace parameters
  int kspacetype;
  myScalar cut_coul, cut_coulsq;
  myScalar *cut_respa;
  myScalar **scale;

  // Wolf
  myScalar g_wolf, woself, dwoself;

  // Ewald
  myScalar g_ewald;

  // QEq
  myScalar *qeq_x, *qeq_j, *qeq_g, *qeq_z, *qeq_c;

  void allocate();
  virtual void read_file(char *);
  void setup_params();
  myScalar self(Param *, myScalar);
  void coulomb_integral_wolf(myScalar, myScalar, myScalar, myScalar &, myScalar &,
        myScalar &, myScalar &);
  void wolf_sum(myScalar, myScalar, myScalar, myScalar, myScalar, myScalar, myScalar,
                  myScalar, myScalar &, myScalar &);
  void coulomb_integral_ewald(myScalar, myScalar, myScalar, myScalar &, myScalar &,
        myScalar &, myScalar &);
  void ewald_sum(myScalar, myScalar, myScalar, myScalar, myScalar, myScalar, myScalar,
