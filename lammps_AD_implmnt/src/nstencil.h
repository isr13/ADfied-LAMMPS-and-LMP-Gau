...
class NStencil : protected Pointers {
 public:
  ...
  myScalar **distsq_multi;           // sq distances to bins in each stencil
 ...
 protected:
  ...
  int neighstyle;
  myScalar cutneighmax;
  myScalar cutneighmaxsq;
  myScalar *cuttypesq;

  // data from NBin class

  int mbinx,mbiny,mbinz;
  myScalar binsizex,binsizey,binsizez;
  ...
  myScalar bin_distance(int, int, int);       // distance between bin corners
};
