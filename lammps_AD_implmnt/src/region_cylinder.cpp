...
int RegCylinder::inside(myScalar x, myScalar y, myScalar z)
{
...
int RegCylinder::surface_interior(myScalar *x, myScalar cutoff)
{
  myScalar del1,del2,r,delta;
...
int RegCylinder::surface_exterior(myScalar *x, myScalar cutoff)
{
  myScalar del1,del2,r;
  myScalar xp,yp,zp;
  myScalar dx, dr, dr2, d2, d2prev;
...
void RegCylinder::velocity_contact_shape(myScalar *vwall, myScalar *xc)
{
