...
class Molecule : protected Pointers {
 public:
  ...
  // nibody,ndbody = # of integer/myScalar fields in body
  ...
  myScalar **x;          // displacement of each atom from origin
  int *type;           // type of each atom
  myScalar *q;           // charge on each atom
  myScalar *radius;      // radius of each atom
  myScalar *rmass;       // mass of each atom
  ...
  int *ibodyparams;         // integer and myScalar body params
  myScalar *dbodyparams;

  myScalar center[3];         // geometric center of molecule
  myScalar masstotal;         // total mass of molecule
  myScalar com[3];            // center of mass of molecule
  myScalar itensor[6];        // moments of inertia of molecule
  myScalar inertia[3];        // principal moments of inertia of molecule
  myScalar ex[3],ey[3],ez[3]; // principal axes of molecule in space coords
  myScalar quat[4];           // quaternion for orientation of molecule

  myScalar maxradius;    // max radius of any atom in molecule
  myScalar molradius;    // radius of molecule from geometric center
                       // including finite-size particle radii
  int comatom;         // index (1-Natom) of atom closest to COM
  myScalar maxextent;    // furthest any atom in molecule is from comatom

  myScalar **dx;         // displacement of each atom relative to center
  myScalar **dxcom;      // displacement of each atom relative to COM
  myScalar **dxbody;     // displacement of each atom relative to COM
                       // in body frame (diagonalized interia tensor)

  myScalar *quat_external;   // orientation imposed by external class
