...
void lammps_extract_box(void *, myScalar *, myScalar *,
                        myScalar *, myScalar *, myScalar *, int *, int *);
void *lammps_extract_atom(void *, char *);
void *lammps_extract_compute(void *, char *, int, int);
void *lammps_extract_fix(void *, char *, int, int, int, int);
void *lammps_extract_variable(void *, char *, char *);

myScalar lammps_get_thermo(void *, char *);
int lammps_get_natoms(void *);

int lammps_set_variable(void *, char *, char *);
void lammps_reset_box(void *, myScalar *, myScalar *, myScalar, myScalar, myScalar);
...
void lammps_create_atoms(void *, int, int64_t *, int *,
                         myScalar *, myScalar *, int64_t *, int);
#else
void lammps_create_atoms(void *, int, int *, int *,
                         myScalar *, myScalar *, int *, int);
#endif
