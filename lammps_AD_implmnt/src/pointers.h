...
#define MIN(A,B) (ad::passive_value((A)) < ad::passive_value((B)) ? ad::passive_value((A)) : ad::passive_value((B)))
#define MAX(A,B) (ad::passive_value((A)) > ad::passive_value((B)) ? ad::passive_value((A)) : ad::passive_value((B)))
