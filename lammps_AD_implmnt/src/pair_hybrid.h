...
class PairHybrid : public Pair {
 ...
 protected:
  ...
  myScalar **special_lj;          // list of per style LJ exclusion factors
  myScalar **special_coul;        // list of per style Coulomb exclusion factors
  ...
  myScalar *save_special();
  void set_special(int);
  void restore_special(myScalar *);
};
