...
class Body : protected Pointers {
 public:
  ...
  virtual int pack_comm_body(struct AtomVecBody::Bonus *, myScalar *) {return 0;}
  virtual int unpack_comm_body(struct AtomVecBody::Bonus *, myScalar *) {return 0;}
  virtual int pack_border_body(struct AtomVecBody::Bonus *, myScalar *) {return 0;}
  virtual int unpack_border_body(struct AtomVecBody::Bonus *,
                                 myScalar *) {return 0;}

  virtual void data_body(int, int, int, int*, myScalar *) = 0;
  virtual int noutrow(int) = 0;
  virtual int noutcol() = 0;
  virtual void output(int, int, myScalar *) = 0;
  virtual int image(int, myScalar, myScalar, int *&, myScalar **&) = 0;

  virtual myScalar radius_body(int, int, int *, myScalar *) {return 0.0;}
};
