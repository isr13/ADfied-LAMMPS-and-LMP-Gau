...
class Bond : protected Pointers {
 ...
 public:
  ...
  virtual myScalar equilibrium_distance(int) = 0;
  virtual void write_restart(FILE *) = 0;
  virtual void read_restart(FILE *) = 0;
  virtual void write_restart_settings(FILE *) {};
  virtual void read_restart_settings(FILE *) {};
  virtual void write_data(FILE *) {}
  virtual myScalar single(int, myScalar, int, int, myScalar &) = 0;
 ...
 protected:
  ...
  void ev_tally(int, int, int, int, myScalar, myScalar, myScalar, myScalar, myScalar);
};
