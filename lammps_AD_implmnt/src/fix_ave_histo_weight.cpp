...
void FixAveHistoWeight::bin_one_weights(myScalar value, myScalar weight)
{
...
void FixAveHistoWeight::bin_vector_weights(int n, myScalar *values,
                                           int stride, myScalar *weights,
                                           int stridewt)
{
  int m = 0;
  int m2 = 0;
...
void FixAveHistoWeight::bin_atoms_weights(myScalar *values, int stride,
                                          myScalar *weights, int stridewt)
{
  int *mask = atom->mask;
