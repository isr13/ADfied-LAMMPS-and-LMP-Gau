...
class Dump : protected Pointers {
 ...
 protected:
  ...
  myScalar boxxlo,boxxhi;      // local copies of domain values
  myScalar boxylo,boxyhi;      // lo/hi are bounding box for triclinic
  myScalar boxzlo,boxzhi;
  myScalar boxxy,boxxz,boxyz;
  ...
  myScalar *buf;               // memory for atom quantities
  ...
  virtual int convert_string(int, myScalar *) {return 0;}
  virtual void write_data(int, myScalar *) = 0;
  void pbc_allocate();
