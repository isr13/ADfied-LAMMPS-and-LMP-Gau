...
int DumpLocal::convert_string(int n, myScalar *mybuf)
{
  int i,j;
...
void DumpLocal::write_data(int n, myScalar *mybuf)
{
...
void DumpLocal::write_string(int n, myScalar *mybuf)
{
...
void DumpLocal::write_lines(int n, myScalar *mybuf)
{
  int i,j;
...
{
  myScalar *vector = compute[field2index[n]]->vector_local;
  myScalar **array = compute[field2index[n]]->array_local;
...
{
  myScalar *vector = fix[field2index[n]]->vector_local;
  myScalar **array = fix[field2index[n]]->array_local;
  int index = argindex[n];
