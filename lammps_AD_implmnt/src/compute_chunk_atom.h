...
class ComputeChunkAtom : public Compute {
 public:
  ...
  myScalar chunk_volume_scalar;
  myScalar *chunk_volume_vec;
  myScalar **coord;
  int *ichunk,*chunkID;
 ...
 private:
  ...
  myScalar origin[3],delta[3];
  myScalar offset[3],invdelta[3];
  myScalar minvalue[3],maxvalue[3];

  // spherical spatial bins

  myScalar sorigin_user[3];
  myScalar sorigin[3];
  myScalar sradmin_user,sradmax_user;
  myScalar sradmin,sradmax,sinvrad;
  int nsbin;

  // cylindrical spatial bins

  myScalar corigin_user[3];
  myScalar corigin[3];
  myScalar cradmin_user,cradmax_user;
  myScalar cradmin,cradmax,cinvrad;
  int cdim1,cdim2;
  int ncbin,ncplane;
