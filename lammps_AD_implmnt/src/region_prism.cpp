...
int RegPrism::inside(myScalar x, myScalar y, myScalar z)
{
  myScalar a = hinv[0][0]*(x-xlo) + hinv[0][1]*(y-ylo) + hinv[0][2]*(z-zlo);
  myScalar b = hinv[1][1]*(y-ylo) + hinv[1][2]*(z-zlo);
  myScalar c = hinv[2][2]*(z-zlo);
...
int RegPrism::surface_interior(myScalar *x, myScalar cutoff)
{
  int i;
  myScalar dot;
  myScalar *corner;
...
int RegPrism::surface_exterior(myScalar *x, myScalar cutoff)
{
  int i;
  myScalar dot;
  myScalar *corner;
...
void RegPrism::find_nearest(myScalar *x, myScalar &xp, myScalar &yp, myScalar &zp)
{
  int i,j,k,iface;
  myScalar xproj[3],xline[3],nearest[3];
  myScalar dot;
...
int RegPrism::inside_tri(myScalar *x, myScalar *v1, myScalar *v2, myScalar *v3,
                         myScalar *norm)
{
  myScalar edge[3],pvec[3],xproduct[3];
...
myScalar RegPrism::closest(myScalar *x, myScalar *near, myScalar *nearest, myScalar dsq)
{
  myScalar delx = x[0] - near[0];
  myScalar dely = x[1] - near[1];
  myScalar delz = x[2] - near[2];
  myScalar rsq = delx*delx + dely*dely + delz*delz;
