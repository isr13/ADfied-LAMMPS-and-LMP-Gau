...
void PairBornCoulWolf::compute(int eflag, int vflag)
{
  ...
  myScalar rsq,r2inv,r6inv,forcecoul,forceborn,factor_coul,factor_lj;
  myScalar prefactor;
  myScalar r,rexp;
  int *ilist,*jlist,*numneigh,**firstneigh;
  myScalar erfcc,erfcd,v_sh,dvdrr,e_self,e_shift,f_shift,qisq;
...
myScalar PairBornCoulWolf::init_one(int i, int j)
{
...
{
  fwrite(&alf,sizeof(myScalar),1,fp);
...
{
  if (comm->me == 0) {
    fread(&alf,sizeof(myScalar),1,fp);
...
myScalar PairBornCoulWolf::single(int i, int j, int itype, int jtype,
                                myScalar rsq,
                                ...
                                myScalar &fforce)
{
  ...
  myScalar e_shift,f_shift,dvdrr,erfcc,erfcd;
