...
myScalar ComputeTempPartial::compute_scalar()
{
...
void ComputeTempPartial::remove_bias(int /*i*/, myScalar *v)
{
  if (!xflag) {
    vbias[0] = v[0];
    v[0] = 0.0;
...
void ComputeTempPartial::remove_bias_thr(int /*i*/, myScalar *v, myScalar *b)
{
  if (!xflag) {
    b[0] = v[0];
    v[0] = 0.0;
...
void ComputeTempPartial::restore_bias(int /*i*/, myScalar *v)
{
...
void ComputeTempPartial::restore_bias_thr(int /*i*/, myScalar *v, myScalar *b)
{
  if (!xflag) v[0] += b[0];
  if (!yflag) v[1] += b[1];
  if (!zflag) v[2] += b[2];
...
myScalar ComputeTempPartial::memory_usage()
{
