...
int DumpCFG::convert_string(int n, myScalar *mybuf)
{
  int i,j;
...
void DumpCFG::write_data(int n, myScalar *mybuf)
{
...
void DumpCFG::write_string(int n, myScalar *mybuf)
{
...
void DumpCFG::write_lines(int n, myScalar *mybuf)
{
  int i,j,m;
