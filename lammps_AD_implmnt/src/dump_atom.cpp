...
int DumpAtom::convert_string(int n, myScalar *mybuf)
{
...
void DumpAtom::write_data(int n, myScalar *mybuf)
{
...
int DumpAtom::convert_image(int n, myScalar *mybuf)
{
  int offset = 0;
  int m = 0;
  for (int i = 0; i < n; i++) {
...
int DumpAtom::convert_noimage(int n, myScalar *mybuf)
{
  int offset = 0;
  int m = 0;
  for (int i = 0; i < n; i++) {
...
void DumpAtom::write_binary(int n, myScalar *mybuf)
{
  n *= size_one;
...
void DumpAtom::write_string(int n, myScalar *mybuf)
{
...
void DumpAtom::write_lines_image(int n, myScalar *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
    fprintf(fp,format,
...
void DumpAtom::write_lines_noimage(int n, myScalar *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
    fprintf(fp,format,
