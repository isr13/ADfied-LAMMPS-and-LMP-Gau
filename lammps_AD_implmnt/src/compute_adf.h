...
class ComputeADF : public Compute {
 ...
 private:
  ...
  myScalar deltax,deltaxinv;             // bin width and inverse-width
  int *ilo,*ihi,*jlo,*jhi,*klo,*khi;
  myScalar **hist;         // histogram bins
  myScalar **histall;      // summed histogram bins across all procs

  myScalar *rcutinnerj, *rcutinnerk; // list of inner cutoffs
  myScalar *rcutouterj, *rcutouterk; // list of outer cutoffs
  ...
  myScalar ***delrjkatom;          // list of 4-vectors: delx, dely, delx, and 1/r

  myScalar rad2deg;        // conversion factor from radians to degrees
