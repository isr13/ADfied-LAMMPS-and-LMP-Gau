...
{
  myScalar dtv,dtf,dte,dtsq;
  myScalar vsq,fsq,massinv;
  myScalar delx,dely,delz,delr;
  ...
  MY_MPI_Allreduce(&dtmin,&dt,1,MPI_DOUBLE,MPI_MIN,world);
...
myScalar FixDtReset::compute_scalar()
{
  return (myScalar) laststep;
}
