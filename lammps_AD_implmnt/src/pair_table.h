...
class PairTable : public Pair {
 ...
 protected:
  ...
  struct Table {
    ...
    myScalar rlo,rhi,fplo,fphi,cut;
    myScalar *rfile,*efile,*ffile;
    myScalar *e2file,*f2file;
    myScalar innersq,delta,invdelta,deltasq6;
    myScalar *rsq,*drsq,*e,*de,*f,*df,*e2,*f2;
  };
  int ntables;
  Table *tables;
  ...
  static void spline(myScalar *, myScalar *, int, myScalar, myScalar, myScalar *);
  static myScalar splint(myScalar *, myScalar *, myScalar *, int, myScalar);
};
