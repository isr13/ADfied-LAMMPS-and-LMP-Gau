...
void PairCoulWolf::compute(int eflag, int vflag)
{
  ...
  myScalar rsq,forcecoul,factor_coul;
  myScalar prefactor;
  myScalar r;
...
myScalar PairCoulWolf::init_one(int /*i*/, int /*j*/)
{
  return cut_coul;
}
...
myScalar PairCoulWolf::single(int i, int j, int /*itype*/, int /*jtype*/, myScalar rsq,
                            myScalar factor_coul, myScalar /*factor_lj*/,
                            myScalar &fforce)
{
  myScalar r,prefactor;
