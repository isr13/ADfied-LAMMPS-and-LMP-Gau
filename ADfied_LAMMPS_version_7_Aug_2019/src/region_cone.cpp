...
int RegCone::inside(myScalar x, myScalar y, myScalar z)
{
  myScalar del1,del2,dist;
  myScalar currentradius;
...
int RegCone::surface_interior(myScalar *x, myScalar cutoff)
{
  myScalar del1,del2,r,currentradius,delx,dely,delz,dist,delta;
  myScalar surflo[3],surfhi[3],xs[3];
...
int RegCone::surface_exterior(myScalar *x, myScalar cutoff)
{
  myScalar del1,del2,r,currentradius,distsq,distsqprev,crad;
  myScalar corner1[3],corner2[3],corner3[3],corner4[3],xp[3],nearest[3];
...
myScalar RegCone::closest(myScalar *x, myScalar *near, myScalar *nearest, myScalar dsq)
{
