...
myScalar PairLJCutCoulDebye::single(int i, int j, int itype, int jtype,
                                  myScalar rsq,
                                  myScalar factor_coul, myScalar factor_lj,
                                  myScalar &fforce)
{
  myScalar r2inv,r6inv,r,rinv,screening,forcecoul,forcelj,phicoul,philj;
