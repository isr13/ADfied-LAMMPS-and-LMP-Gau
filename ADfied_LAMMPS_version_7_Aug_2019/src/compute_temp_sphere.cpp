...
void ComputeTempSphere::dof_compute()
{
  ...
  MY_MPI_Allreduce(&count,&count_all,1,MPI_INT,MPI_SUM,world);
  dof = count_all;
...
myScalar ComputeTempSphere::compute_scalar()
{
...
void ComputeTempSphere::compute_vector()
{
  ...
  myScalar massone,inertiaone,t[6];
...
void ComputeTempSphere::remove_bias(int i, myScalar *v)
{
...
void ComputeTempSphere::remove_bias_thr(int i, myScalar *v, myScalar *b)
{
...
void ComputeTempSphere::restore_bias(int i, myScalar *v)
{
...
void ComputeTempSphere::restore_bias_thr(int i, myScalar *v, myScalar *b)
{
