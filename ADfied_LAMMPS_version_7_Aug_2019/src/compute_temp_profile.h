...
class ComputeTempProfile : public Compute {
 public:
  ...
  void remove_bias(int, myScalar *);
  void remove_bias_thr(int, myScalar *, myScalar *);
  void remove_bias_all();
  void restore_bias(int, myScalar *);
  void restore_bias_thr(int, myScalar *, myScalar *);
 ...
 private:
  ...
  int maxatom;
  int *bin;
  myScalar **vbin,**binave;
  myScalar *tbin,*tbinall;
