...
myScalar PairCoulStreitz::init_one(int i, int j)
{
  scale[j][i] = scale[i][j];
...
void PairCoulStreitz::compute(int eflag, int vflag)
{
  ...
  myScalar xtmp, ytmp, ztmp, ecoul, fpair;
  myScalar qi, qj, selfion, r, rsq, delr[3];
  myScalar zei, zej, zj, ci_jfi, dci_jfi, ci_fifj, dci_fifj;
  myScalar forcecoul, factor_coul;
...
myScalar PairCoulStreitz::self(Param *param, myScalar qi)
{
 myScalar s1=param->chi, s2=param->eta;
...
void PairCoulStreitz::coulomb_integral_wolf(myScalar zei, myScalar zej, myScalar r,
                  myScalar &ci_jfi, myScalar &dci_jfi, myScalar &ci_fifj,
                  myScalar &dci_fifj)
{
  myScalar rinv = 1.0/r;
  myScalar rinv2 = rinv*rinv;

  myScalar exp2zir = exp(-2.0*zei*r);
  myScalar zei2 = zei*zei;
  myScalar zei4 = zei2*zei2;
  myScalar zei6 = zei2*zei4;

  myScalar exp2zjr = exp(-2.0*zej*r);
  myScalar zej2 = zej*zej;
  myScalar zej4 = zej2*zej2;
  myScalar zej6 = zej2*zej4;

  myScalar sm1 = 11.0/8.0;
  myScalar sm2 = 3.00/4.0;
  myScalar sm3 = 1.00/6.0;
  myScalar e1, e2, e3, e4;

  myScalar rc = cut_coul;
  myScalar rcinv = 1.0/rc;
  myScalar rcinv2 = rcinv*rcinv;
  myScalar exp2zirsh = exp(-2.0*zei*rc);
  myScalar exp2zjrsh = exp(-2.0*zej*rc);
  myScalar eshift, fshift;
...
void PairCoulStreitz::wolf_sum(myScalar qi, myScalar qj, myScalar zj, myScalar r,
                myScalar ci_jfi, myScalar dci_jfi, myScalar ci_fifj,
                myScalar dci_fifj, myScalar &etmp, myScalar &ftmp)
{
  myScalar a = g_wolf;
  myScalar rc = cut_coul;
  myScalar qqrd2e = force->qqrd2e;

  myScalar erfcr = erfc(a*r);
  myScalar derfcr = exp(-a*a*r*r);
  myScalar erfcrc = erfc(a*rc);

  myScalar etmp1, etmp2, etmp3;
  myScalar ftmp1, ftmp2, ftmp3;
...
void PairCoulStreitz::coulomb_integral_ewald(myScalar zei, myScalar zej, myScalar r,
                  myScalar &ci_jfi, myScalar &dci_jfi, myScalar &ci_fifj,
                  myScalar &dci_fifj)
{
  myScalar rinv = 1.0/r;
...
void PairCoulStreitz::ewald_sum(myScalar qi, myScalar qj, myScalar zj, myScalar r,
                myScalar ci_jfi, myScalar dci_jfi, myScalar ci_fifj,
                myScalar dci_fifj, myScalar &etmp, myScalar &ftmp, myScalar fac)
{
  myScalar etmp1, etmp2, etmp3, etmp4;
  myScalar ftmp1, ftmp2, ftmp3, ftmp4;
...
myScalar PairCoulStreitz::memory_usage()
{
