...
int RegUnion::inside(myScalar x, myScalar y, myScalar z)
{
  int ilist;
  Region **regions = domain->regions;
...
int RegUnion::surface_interior(myScalar *x, myScalar cutoff)
{
...
int RegUnion::surface_exterior(myScalar *x, myScalar cutoff)
{
  int m,ilist,jlist,iregion,jregion,ncontacts;
  myScalar xs,ys,zs;
