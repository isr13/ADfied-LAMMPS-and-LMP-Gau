...
int AtomVecSphere::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecSphere::pack_comm_vel(int n, int *list, myScalar *buf,
                                   int pbc_flag, int *pbc)
{
  int i,j,m;
...
int AtomVecSphere::pack_comm_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecSphere::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecSphere::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecSphere::unpack_comm_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecSphere::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecSphere::pack_reverse_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecSphere::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecSphere::unpack_reverse_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecSphere::pack_border(int n, int *list, myScalar *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecSphere::pack_border_vel(int n, int *list, myScalar *buf,
                                   int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecSphere::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecSphere::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecSphere::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecSphere::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecSphere::pack_exchange(int i, myScalar *buf)
{
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
...
int AtomVecSphere::unpack_exchange(myScalar *buf)
{
...
int AtomVecSphere::pack_restart(int i, myScalar *buf)
{
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
...
int AtomVecSphere::unpack_restart(myScalar *buf)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
void AtomVecSphere::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecSphere::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
  ...
  myScalar density = utils::numeric(FLERR,values[3],true,lmp);
  if (density <= 0.0)
...
int AtomVecSphere::data_atom_hybrid(int nlocal, char **values)
{
  ...
  myScalar density = utils::numeric(FLERR,values[1],true,lmp);
  if (density <= 0.0)
    error->one(FLERR,"Invalid density in Atoms section of data file");
...
void AtomVecSphere::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecSphere::pack_data_hybrid(int i, myScalar *buf)
{
  buf[0] = 2.0*radius[i];
...
void AtomVecSphere::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecSphere::write_data_hybrid(FILE *fp, myScalar *buf)
{
...
void AtomVecSphere::pack_vel(myScalar **buf)
{
  int nlocal = atom->nlocal;
  for (int i = 0; i < nlocal; i++) {
    buf[i][0] = ubuf(tag[i]).d;
...
int AtomVecSphere::pack_vel_hybrid(int i, myScalar *buf)
{
  buf[0] = omega[i][0];
  buf[1] = omega[i][1];
  buf[2] = omega[i][2];
...
void AtomVecSphere::write_vel(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
    fprintf(fp,TAGINT_FORMAT
...
int AtomVecSphere::write_vel_hybrid(FILE *fp, myScalar *buf)
{
