...
myScalar ComputeTempCOM::compute_scalar()
{
  myScalar vthermal[3];
...
void ComputeTempCOM::remove_bias(int /*i*/, myScalar *v)
{
  v[0] -= vbias[0];
  v[1] -= vbias[1];
  v[2] -= vbias[2];
...
void ComputeTempCOM::remove_bias_thr(int, myScalar *v, myScalar *)
{
  v[0] -= vbias[0];
  v[1] -= vbias[1];
  v[2] -= vbias[2];
...
void ComputeTempCOM::restore_bias(int /*i*/, myScalar *v)
{
  v[0] += vbias[0];
  v[1] += vbias[1];
  v[2] += vbias[2];
...
void ComputeTempCOM::restore_bias_thr(int, myScalar *v, myScalar *)
{
  v[0] += vbias[0];
  v[1] += vbias[1];
  v[2] += vbias[2];
