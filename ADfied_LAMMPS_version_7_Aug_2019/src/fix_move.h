...
class FixMove : public Fix {
 ...
 private:
  ...
  myScalar vx,vy,vz,ax,ay,az;
  myScalar period,omega_rotate;
  myScalar point[3],axis[3],runit[3];
  myScalar dt,dtv,dtf;
  ...
  myScalar **xoriginal;         // original coords of atoms
  myScalar *toriginal;          // original theta of atoms
  myScalar **qoriginal;         // original quat of atoms
  int displaceflag,velocityflag;
  int maxatom;
  myScalar **displace,**velocity;
