...
void Improper::ev_tally(int i1, int i2, int i3, int i4,
                        ...
                        myScalar eimproper, myScalar *f1, myScalar *f3, myScalar *f4,
                        myScalar vb1x, myScalar vb1y, myScalar vb1z,
                        myScalar vb2x, myScalar vb2y, myScalar vb2z,
                        myScalar vb3x, myScalar vb3y, myScalar vb3z)
{
  myScalar eimproperquarter,v[6];
...
myScalar Improper::memory_usage()
{
