...
class NPair : protected Pointers {
 public:
  ...
  myScalar cutoff_custom;         // cutoff set by requestor
 ...
 protected:
  myScalar **mycutneighsq;         // per-type cutoffs when user specified
  ...
  myScalar skin;
  myScalar **cutneighsq;
  myScalar **cutneighghostsq;
  myScalar cut_inner_sq;
  myScalar cut_middle_sq;
  myScalar cut_middle_inside_sq;
  myScalar *bboxlo,*bboxhi;
  ...
  myScalar bininvx,bininvy,bininvz;
  int *atom2bin,*bins;
  int *binhead;
  ...
  int coord2bin(myScalar *);                     // mapping atom coord to a bin
  int coord2bin(myScalar *, int &, int &, int&); // ditto
