...
int DumpXYZ::convert_string(int n, myScalar *mybuf)
{
  int offset = 0;
  int m = 0;
  for (int i = 0; i < n; i++) {
...
void DumpXYZ::write_data(int n, myScalar *mybuf)
{
...
void DumpXYZ::write_string(int n, myScalar *mybuf)
{
...
void DumpXYZ::write_lines(int n, myScalar *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
    fprintf(fp,format,
