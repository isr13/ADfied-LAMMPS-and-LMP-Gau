...
void Angle::ev_tally(int i, int j, int k, int nlocal, int newton_bond,
                     myScalar eangle, myScalar *f1, myScalar *f3,
                     myScalar delx1, myScalar dely1, myScalar delz1,
                     myScalar delx2, myScalar dely2, myScalar delz2)
{
  myScalar eanglethird,v[6];
