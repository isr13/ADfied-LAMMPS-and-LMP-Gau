...
int AtomVecHybrid::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecHybrid::pack_comm_vel(int n, int *list, myScalar *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,k,m;
...
void AtomVecHybrid::unpack_comm(int n, int first, myScalar *buf)
{
  int i,k,m,last;
...
void AtomVecHybrid::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,k,m,last;
  int omega_flag = atom->omega_flag;
  int angmom_flag = atom->angmom_flag;
...
int AtomVecHybrid::pack_reverse(int n, int first, myScalar *buf)
{
  int i,k,m,last;
...
void AtomVecHybrid::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,k,m;
...
int AtomVecHybrid::pack_border(int n, int *list, myScalar *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,k,m;
  myScalar dx,dy,dz;
...
int AtomVecHybrid::pack_border_vel(int n, int *list, myScalar *buf,
                                   int pbc_flag, int *pbc)
{
  int i,j,k,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
void AtomVecHybrid::unpack_border(int n, int first, myScalar *buf)
{
  int i,k,m,last;
...
void AtomVecHybrid::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,k,m,last;
  int omega_flag = atom->omega_flag;
  int angmom_flag = atom->angmom_flag;
...
int AtomVecHybrid::pack_exchange(int i, myScalar *buf)
{
  int k,m;
...
int AtomVecHybrid::unpack_exchange(myScalar *buf)
{
  int k,m;
...
int AtomVecHybrid::pack_restart(int i, myScalar *buf)
{
  int tmp = atom->nextra_restart;
  atom->nextra_restart = 0;
...
int AtomVecHybrid::unpack_restart(myScalar *buf)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
void AtomVecHybrid::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecHybrid::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecHybrid::pack_data(myScalar **buf)
{
  int k,m;
...
void AtomVecHybrid::write_data(FILE *fp, int n, myScalar **buf)
{
  int k,m;
...
void AtomVecHybrid::pack_vel(myScalar **buf)
{
  int k,m;
...
void AtomVecHybrid::write_vel(FILE *fp, int n, myScalar **buf)
{
  int k,m;
...
void AtomVecHybrid::pack_property_atom(int multiindex, myScalar *buf,
