...
class FixNeighHistory : public Fix {
 public:
  ...
  myScalar **firstvalue;          // ptr to each atom's values
  ...
  int pack_reverse_comm(int, int, myScalar *);
  void unpack_reverse_comm(int, int *, myScalar *);
 ...
 protected:
  ...
  myScalar **valuepartner;        // values for the partners
