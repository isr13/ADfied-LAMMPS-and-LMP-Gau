...
void FixExternal::set_energy_global(myScalar caller_energy)
{
...
void FixExternal::set_virial_global(myScalar *caller_virial)
{
  if (!evflag) return;
...
void FixExternal::set_energy_peratom(myScalar *caller_energy)
{
...
void FixExternal::set_virial_peratom(myScalar **caller_virial)
{
  int i,j;
...
void FixExternal::set_vector(int index, myScalar value)
{
...
myScalar FixExternal::compute_scalar()
{
  return user_energy;
}
...
myScalar FixExternal::compute_vector(int n)
{
...
myScalar FixExternal::memory_usage()
{
  myScalar bytes = 3*atom->nmax * sizeof(myScalar);
  return bytes;
}
...
int FixExternal::pack_exchange(int i, myScalar *buf)
{
  buf[0] = fexternal[i][0];
  buf[1] = fexternal[i][1];
  buf[2] = fexternal[i][2];
...
int FixExternal::unpack_exchange(int nlocal, myScalar *buf)
{
