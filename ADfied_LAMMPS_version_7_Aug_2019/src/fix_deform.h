...
class FixDeform : public Fix {
 ...
 protected:
  ...
  struct Set {
    int style,substyle;
    myScalar flo,fhi,ftilt;
    myScalar dlo,dhi,dtilt;
    myScalar scale,vel,rate;
    myScalar amplitude,tperiod;
    myScalar lo_initial,hi_initial;
    myScalar lo_start,hi_start,lo_stop,hi_stop,lo_target,hi_target;
    myScalar tilt_initial,tilt_start,tilt_stop,tilt_target,tilt_flip;
    myScalar tilt_min,tilt_max;
    myScalar vol_initial,vol_start;
