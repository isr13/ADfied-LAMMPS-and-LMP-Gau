...
myScalar Calculate_Omega( rvec dvec_ij, myScalar r_ij,
                      rvec dvec_jk, myScalar r_jk,
                      rvec dvec_kl, myScalar r_kl,
                      rvec dvec_li, myScalar r_li,
...
{
  myScalar unnorm_cos_omega, unnorm_sin_omega, omega;
  myScalar sin_ijk, cos_ijk, sin_jkl, cos_jkl;
  myScalar htra, htrb, htrc, hthd, hthe, hnra, hnrc, hnhd, hnhe;
  myScalar arg, poem, tel;
  rvec cross_jk_kl;
                     ...
                     reax_list **lists, output_controls *out_control )
{
  ...
  myScalar Delta_j, Delta_k;
  myScalar r_ij, r_jk, r_kl, r_li;
  myScalar BOA_ij, BOA_jk, BOA_kl;

  myScalar exp_tor2_ij, exp_tor2_jk, exp_tor2_kl;
  myScalar exp_tor1, exp_tor3_DjDk, exp_tor4_DjDk, exp_tor34_inv;
  myScalar exp_cot2_jk, exp_cot2_ij, exp_cot2_kl;
  myScalar fn10, f11_DjDk, dfn11, fn12;
  myScalar theta_ijk, theta_jkl;
  myScalar sin_ijk, sin_jkl;
  myScalar cos_ijk, cos_jkl;
  myScalar tan_ijk_i, tan_jkl_i;
  myScalar omega, cos_omega, cos2omega, cos3omega;
  rvec dcos_omega_di, dcos_omega_dj, dcos_omega_dk, dcos_omega_dl;
  myScalar CV, cmn, CEtors1, CEtors2, CEtors3, CEtors4;
  myScalar CEtors5, CEtors6, CEtors7, CEtors8, CEtors9;
  myScalar Cconj, CEconj1, CEconj2, CEconj3;
  myScalar CEconj4, CEconj5, CEconj6;
  myScalar e_tor, e_con;
  rvec dvec_li;
  ...
  myScalar p_tor2 = system->reax_param.gp.l[23];
  myScalar p_tor3 = system->reax_param.gp.l[24];
  myScalar p_tor4 = system->reax_param.gp.l[25];
  myScalar p_cot2 = system->reax_param.gp.l[27];
  reax_list *bonds = (*lists) + BONDS;
  reax_list *thb_intrs = (*lists) + THREE_BODIES;

  // Virial tallying variables
  myScalar delil[3], deljl[3], delkl[3];
