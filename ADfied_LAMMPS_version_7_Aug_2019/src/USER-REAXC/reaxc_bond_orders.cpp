...
int BOp( storage *workspace, reax_list *bonds, myScalar bo_cut,
         int i, int btop_i, far_neighbor_data *nbr_pj,
         single_body_parameters *sbp_i, single_body_parameters *sbp_j,
         two_body_parameters *twbp ) {
  int j, btop_j;
  myScalar r2, C12, C34, C56;
  myScalar Cln_BOp_s, Cln_BOp_pi, Cln_BOp_pi2;
         ...
         storage *workspace, reax_list **lists, output_controls * /*out_control*/ )
{
  ...
  myScalar val_i, Deltap_i, Deltap_boc_i;
  myScalar val_j, Deltap_j, Deltap_boc_j;
  myScalar f1, f2, f3, f4, f5, f4f5, exp_f4, exp_f5;
  myScalar exp_p1i,        exp_p2i, exp_p1j, exp_p2j;
  myScalar temp, u1_ij, u1_ji, Cf1A_ij, Cf1B_ij, Cf1_ij, Cf1_ji;
  myScalar Cf45_ij, Cf45_ji, p_lp1; //u_ij, u_ji
  myScalar A0_ij, A1_ij, A2_ij, A2_ji, A3_ij, A3_ji;
  myScalar explp1, p_boc1, p_boc2;
