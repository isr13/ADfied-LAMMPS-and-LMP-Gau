...
static myScalar Dot( myScalar* v1, myScalar* v2, int k )
{
  myScalar ret = 0.0;
...
void Calculate_Theta( rvec dvec_ji, myScalar d_ji, rvec dvec_jk, myScalar d_jk,
                      myScalar *theta, myScalar *cos_theta )
{
...
void Calculate_dCos_Theta( rvec dvec_ji, myScalar d_ji, rvec dvec_jk, myScalar d_jk,
                           rvec* dcos_theta_di,
                           rvec* dcos_theta_dj,
                           rvec* dcos_theta_dk )
{
  int t;
  myScalar sqr_d_ji = SQR(d_ji);
  myScalar sqr_d_jk = SQR(d_jk);
  myScalar inv_dists = 1.0 / (d_ji * d_jk);
  myScalar inv_dists3 = pow( inv_dists, 3.0 );
  myScalar dot_dvecs = Dot( dvec_ji, dvec_jk, 3 );
  myScalar Cdot_inv3 = dot_dvecs * inv_dists3;
                     ...
                     reax_list **lists, output_controls * /*out_control*/ )
{
  ...
  myScalar temp, temp_bo_jt, pBOjt7;
  myScalar p_val1, p_val2, p_val3, p_val4, p_val5;
  myScalar p_val6, p_val7, p_val8, p_val9, p_val10;
  myScalar p_pen1, p_pen2, p_pen3, p_pen4;
  myScalar p_coa1, p_coa2, p_coa3, p_coa4;
  myScalar trm8, expval6, expval7, expval2theta, expval12theta, exp3ij, exp3jk;
  myScalar exp_pen2ij, exp_pen2jk, exp_pen3, exp_pen4, trm_pen34, exp_coa2;
  myScalar dSBO1, dSBO2, SBO, SBO2, CSBO2, SBOp, prod_SBO, vlpadj;
  myScalar CEval1, CEval2, CEval3, CEval4, CEval5, CEval6, CEval7, CEval8;
  myScalar CEpen1, CEpen2, CEpen3;
  myScalar e_ang, e_coa, e_pen;
  myScalar CEcoa1, CEcoa2, CEcoa3, CEcoa4, CEcoa5;
  myScalar Cf7ij, Cf7jk, Cf8j, Cf9j;
  myScalar f7_ij, f7_jk, f8_Dj, f9_Dj;
  myScalar Ctheta_0, theta_0, theta_00, theta, cos_theta, sin_theta;
  myScalar BOA_ij, BOA_jk;
  rvec force, ext_press;

  // Tallying variables
  myScalar eng_tmp, fi_tmp[3], fj_tmp[3], fk_tmp[3];
  myScalar delij[3], delkj[3];
