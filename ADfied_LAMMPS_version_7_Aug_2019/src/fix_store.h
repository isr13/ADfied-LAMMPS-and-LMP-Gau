...
class FixStore : public Fix {
 public:
  ...
  myScalar *vstore;        // vector storage for GLOBAL or PERATOM
  myScalar **astore;       // array storage for GLOBAL or PERATOM
 ...
 private:
  ...
  myScalar *rbuf;                 // restart buffer for GLOBAL vec/array
};
