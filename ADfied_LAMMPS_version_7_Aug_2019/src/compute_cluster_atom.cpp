...
int ComputeClusterAtom::pack_forward_comm(int n, int *list, myScalar *buf,
...
void ComputeClusterAtom::unpack_forward_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
myScalar ComputeClusterAtom::memory_usage()
{
