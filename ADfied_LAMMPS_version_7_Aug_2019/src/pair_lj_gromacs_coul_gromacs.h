...
class PairLJGromacsCoulGromacs : public Pair {
 ...
 protected:
  myScalar cut_lj_inner,cut_lj,cut_coul_inner,cut_coul;
  myScalar cut_lj_innersq,cut_ljsq,cut_coul_innersq,cut_coulsq,cut_bothsq;
  myScalar **epsilon,**sigma;
  myScalar **lj1,**lj2,**lj3,**lj4;
  myScalar **ljsw1,**ljsw2,**ljsw3,**ljsw4,**ljsw5;
  myScalar coulsw1,coulsw2,coulsw3,coulsw4,coulsw5;
