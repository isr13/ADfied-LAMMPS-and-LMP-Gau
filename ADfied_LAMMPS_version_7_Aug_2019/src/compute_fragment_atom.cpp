...
int ComputeFragmentAtom::pack_forward_comm(int n, int *list, myScalar *buf,
...
void ComputeFragmentAtom::unpack_forward_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int ComputeFragmentAtom::pack_reverse_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void ComputeFragmentAtom::unpack_reverse_comm(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
myScalar ComputeFragmentAtom::memory_usage()
{
