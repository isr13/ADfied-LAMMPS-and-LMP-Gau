...
class RegionDeprecated : public Region {
 public:
  ...
  ~RegionDeprecated() {}
  virtual void init() {}
  virtual int inside(myScalar, myScalar, myScalar) { return 0; }
  virtual int surface_interior(myScalar *, myScalar) { return 0; }
  virtual int surface_exterior(myScalar *, myScalar) { return 0; }
 };
