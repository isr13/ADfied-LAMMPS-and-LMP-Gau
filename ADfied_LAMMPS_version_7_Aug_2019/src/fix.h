...
class Fix : protected Pointers {
 public:
  ...
  myScalar *vector_atom;           // computed per-atom vector
  myScalar **array_atom;           // computed per-atom array
  myScalar *vector_local;          // computed local vector
  myScalar **array_local;          // computed local array
  ...
  virtual void set_molecule(int, tagint, int, myScalar *, myScalar *, myScalar *) {}
  virtual void clear_bonus() {}

  virtual int pack_border(int, int *, myScalar *) {return 0;}
  virtual int unpack_border(int, int, myScalar *) {return 0;}
  virtual int pack_exchange(int, myScalar *) {return 0;}
  virtual int unpack_exchange(int, myScalar *) {return 0;}
  virtual int pack_restart(int, myScalar *) {return 0;}
  ...
  virtual myScalar min_energy(myScalar *) {return 0.0;}
  ...
  virtual void min_step(myScalar, myScalar *) {}
  virtual myScalar max_alpha(myScalar *) {return 0.0;}
  ...
  virtual myScalar compute_scalar() {return 0.0;}
  virtual myScalar compute_vector(int) {return 0.0;}
  virtual myScalar compute_array(int,int) {return 0.0;}

  virtual int dof(int) {return 0;}
  virtual void deform(int) {}
  virtual void reset_target(myScalar) {}
  ...
  virtual void write_data_section_pack(int, myScalar **) {}
  virtual void write_data_section_keyword(int, FILE *) {}
  virtual void write_data_section(int, FILE *, int, myScalar **, int) {}
  ...
  virtual int image(int *&, myScalar **&) {return 0;}
 ...
 protected:
  ...
  void ev_tally(int, int *, myScalar, myScalar, myScalar *);
  void v_setup(int);
  void v_tally(int, int *, myScalar, myScalar *);
  void v_tally(int, myScalar *);
  void v_tally(int, int, myScalar);
