...
void PairTIP4PCut::compute(int eflag, int vflag)
{
  ...
  myScalar qtmp,xtmp,ytmp,ztmp,delx,dely,delz,ecoul;
  myScalar rsq,r2inv,forcecoul,factor_coul;
...
myScalar PairTIP4PCut::init_one(int /*i*/, int /*j*/)
{
...
void PairTIP4PCut::compute_newsite(myScalar *xO,  myScalar *xH1,
...
myScalar PairTIP4PCut::memory_usage()
{
