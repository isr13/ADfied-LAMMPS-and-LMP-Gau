...
int AtomVecTemplate::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecTemplate::pack_comm_vel(int n, int *list, myScalar *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecTemplate::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecTemplate::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecTemplate::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecTemplate::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecTemplate::pack_border(int n, int *list, myScalar *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecTemplate::pack_border_vel(int n, int *list, myScalar *buf,
                                   int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecTemplate::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecTemplate::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecTemplate::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecTemplate::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecTemplate::pack_exchange(int i, myScalar *buf)
{
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
...
int AtomVecTemplate::unpack_exchange(myScalar *buf)
{
...
int AtomVecTemplate::pack_restart(int i, myScalar *buf)
{
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
...
int AtomVecTemplate::unpack_restart(myScalar *buf)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
void AtomVecTemplate::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecTemplate::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecTemplate::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecTemplate::pack_data_hybrid(int i, myScalar *buf)
{
...
void AtomVecTemplate::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecTemplate::write_data_hybrid(FILE *fp, myScalar *buf)
{
