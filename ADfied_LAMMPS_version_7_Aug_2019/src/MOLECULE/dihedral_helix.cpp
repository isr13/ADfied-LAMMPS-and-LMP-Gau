...
void DihedralHelix::coeff(int narg, char **arg)
{
  ...
  myScalar aphi_one = force->numeric(FLERR,arg[1]);
  myScalar bphi_one = force->numeric(FLERR,arg[2]);
  myScalar cphi_one = force->numeric(FLERR,arg[3]);
...
{
  fwrite(&aphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  fwrite(&bphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  fwrite(&cphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
}
...
void DihedralHelix::read_restart(FILE *fp)
{
  ...
  if (comm->me == 0) {
    fread(&aphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
    fread(&bphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
    fread(&cphi[1],sizeof(myScalar),atom->ndihedraltypes,fp);
  }
