...
int AtomVecBond::pack_comm(int n, int *list, myScalar *buf,
...
int AtomVecBond::pack_comm_vel(int n, int *list, myScalar *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecBond::unpack_comm(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecBond::unpack_comm_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecBond::pack_reverse(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecBond::unpack_reverse(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
int AtomVecBond::pack_border(int n, int *list, myScalar *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz;
...
int AtomVecBond::pack_border_vel(int n, int *list, myScalar *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  myScalar dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecBond::pack_border_hybrid(int n, int *list, myScalar *buf)
{
  int i,j,m;
...
void AtomVecBond::unpack_border(int n, int first, myScalar *buf)
{
  int i,m,last;
...
void AtomVecBond::unpack_border_vel(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecBond::unpack_border_hybrid(int n, int first, myScalar *buf)
{
  int i,m,last;
...
int AtomVecBond::pack_exchange(int i, myScalar *buf)
{
  int k;
...
int AtomVecBond::unpack_exchange(myScalar *buf)
{
  int k;
...
int AtomVecBond::pack_restart(int i, myScalar *buf)
{
  int k;
...
int AtomVecBond::unpack_restart(myScalar *buf)
{
  int k;
...
void AtomVecBond::create_atom(int itype, myScalar *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecBond::data_atom(myScalar *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecBond::pack_data(myScalar **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecBond::pack_data_hybrid(int i, myScalar *buf)
{
...
void AtomVecBond::write_data(FILE *fp, int n, myScalar **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecBond::write_data_hybrid(FILE *fp, myScalar *buf)
{
