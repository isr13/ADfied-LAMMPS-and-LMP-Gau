...
void PairLJCharmmfswCoulCharmmfsh::compute(int eflag, int vflag)
{
  ...
  myScalar qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,evdwl12,evdwl6,ecoul,fpair;
  myScalar r,rinv,r3inv,rsq,r2inv,r6inv,forcecoul,forcelj,factor_coul,factor_lj;
  myScalar switch1;
...
myScalar PairLJCharmmfswCoulCharmmfsh::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
myScalar PairLJCharmmfswCoulCharmmfsh::
single(int i, int j, int itype, int jtype,
       myScalar rsq, myScalar factor_coul, myScalar factor_lj, myScalar &fforce)
{
  myScalar r,rinv,r2inv,r3inv,r6inv,forcecoul,forcelj;
  myScalar phicoul,philj,philj12,philj6;
  myScalar switch1;
