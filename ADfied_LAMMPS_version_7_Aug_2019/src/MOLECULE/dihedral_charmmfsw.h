...
class DihedralCharmmfsw : public Dihedral {
 ...
 protected:
  ...
  myScalar cut_lj_inner14,cut_lj14,cut_coul14;
  myScalar evdwl14_12,evdwl14_6,cut_coulinv14;
  myScalar cut_lj_inner3inv,cut_lj_inner6inv,cut_lj3inv,cut_lj6inv;

  myScalar *k,*weight,*cos_shift,*sin_shift;
